...
(function($) {
    ...
    Timepicker.prototype = {
        init: function() {
            ...
            this._colonPos = -1;
            this._visible = false;
            this.tpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible" style="width: 100px; z-index: 1003; display: none; position: absolute;"></div>');
            this._generateHtml();
        },
        ...
        _generateHtml: function () {
            ...
            html += '<span class="fragHours">08</span><span class="delim">:</span><span class="fragMinutes">45</span><span class="delim">:</span><span class="fragSec">00</span> <span class="fragAmpm"></span></div></div><table>';
